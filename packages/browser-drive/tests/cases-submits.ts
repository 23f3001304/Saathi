...
export const AUTH_BUTTON_CASES: readonly Case[] = [
  ...
  b("Log in", "Log in", {}, "login_context", "login"),
  b("Sign in", "Sign in", {}, "login_context", "login"),
  b("Sign up", "Sign up", {}, "login_context", "login"),
  b("Create an account", "Create an account", {}, "login_context", "login"),
  b(
  ...
  b("लॉग इन", "लॉग इन", {}, "login_context", "login"),
  b("साइन अप", "साइन अप", {}, "login_context", "login"),
  b(
