...
export const CHECKOUT_COMMIT_CASES: readonly Case[] = [
  ...
  b("Buy it now", "Buy it now", { pageUrl: PAY }, "payment_button", "payment"),
  b(
    "Place your order",
    "Place your order",
    { pageUrl: PAY },
  ...
  b("Pay now", "Pay now", { pageUrl: PAY }, "payment_button", "payment"),
  b(
  ...
  b("अभी खरीदें", "अभी खरीदें", { pageUrl: PAY }, "payment_button", "payment"),
